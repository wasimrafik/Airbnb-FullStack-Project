    ...
    {action === 'new' && (
        <div>
            <form>
              ...
              <p className="text-gray-500 text-sm">Title fir your place should be short and catchy as in advertisment</p>
              <input  type="text" name="" placeholder="Title, ex:- My Lovely Apt"/>
              ...
              <p className="text-gray-500 text-sm">select all the perks for your places</p> 
              ...
              <p className="text-gray-500 text-sm">hose rules, etc</p> 
              <textarea />
              
              
              <h2 className="text-2xl mt-4">CheckIn & CheckOut Time</h2>   
              <p className="text-gray-500 text-sm">Add checkIn and CheckOut time</p> 
              ...
              <div className="grid gap-2 sm:grid-cols-3">
                ...
                <div>   
                    ...
                    <input type="text" placeholder="no of guestes"/>
                </div>
              </div>
